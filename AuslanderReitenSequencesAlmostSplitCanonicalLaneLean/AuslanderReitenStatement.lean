...
import AuslanderReitenSequencesAlmostSplitCanonicalLaneLean.AuslanderReitenObjects
...
def theoremSpecificEndgamePilotClosed : Prop :=
  forall A : ARAdmittedObject, ConstrainedARClosure A

theorem theorem_specific_endgame_pilot_checked :
    theoremSpecificEndgamePilotClosed := by
  intro A
  exact constrained_ar_endgame A
